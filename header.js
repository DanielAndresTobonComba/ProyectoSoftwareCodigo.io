        ...
        <div class="seccionLogo ">
            ...
            <div class="seccionInicio">
                <div class="iniciarSesion ">
                    <svg  class="simboloInicioSesion" onclick="iniciosesion()" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user" width="100%" height="80%" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
